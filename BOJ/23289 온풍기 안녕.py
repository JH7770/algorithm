...
def isWall(loc, nloc, d):
    ...
    if x == nx or y == ny:
        ...
        return wall[y][x][ny][nx] or wall[ny][x][ny][nx]
    else:
        return wall[y][x][ny][nx] or wall[y][nx][ny][nx]
    ...
    for x, y in heaters:
        ...
        while q:
            ...
            for dx2, dy2 in d[direction]:
                ...
                if isWall((sx, sy), (nx, ny), direction) : continue
        ...
        for y in range(C):
            for d in range(4):
                ...
                if nx < 0 or ny < 0 or nx >= R or ny >= C:
                    continue
                if isWall((x,y), (nx, ny), d):continue
